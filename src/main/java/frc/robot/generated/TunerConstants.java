...
public class TunerConstants {
    ...
    private static final Slot0Configs steerGains = new Slot0Configs()
        .withKP(120).withKI(0).withKD(0.0)
        .withKS(0.1).withKV(0.0).withKA(0.0)
        .withStaticFeedforwardSign(StaticFeedforwardSignValue.UseClosedLoopSign);

        //200, 0, 11, 3.21854, 1.19624, 0
    // When using closed-loop control, the drive motor uses the control
    // output type specified by SwerveModuleConstants.DriveMotorClosedLoopOutput
    private static final Slot0Configs driveGainsTorque = new Slot0Configs()
        .withKP(40).withKI(0.0).withKD(.8)
        .withKS(4.9634).withKV(0).withKA(3.9565);
        // 50, 0.0, .8
        // 4.9634, 0.0, 3.9565
        // 40, 0, 0.8
    ...
    private static final SwerveModuleConstantsFactory<TalonFXConfiguration, TalonFXConfiguration, CANcoderConfiguration> ConstantCreator =
        new SwerveModuleConstantsFactory<TalonFXConfiguration, TalonFXConfiguration, CANcoderConfiguration>()
            ...
            .withDriveMotorGains(driveGainsTorque)
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(0.182861328125);
    ...
    private static final Angle kFrontRightEncoderOffset = Rotations.of(-0.190185546875);
